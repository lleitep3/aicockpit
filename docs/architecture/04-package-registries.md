...
*(Para o guia detalhado prático de como criar os arquivos do repositório, veja nosso manual em [Package Registry Setup](../kb/guides/package-registry-setup.md)).*
