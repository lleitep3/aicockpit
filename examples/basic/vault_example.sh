...
cockpit vault set example_api_key --value "sk-test-1234567890abcdef"
echo "   ✓ example_api_key criado"

cockpit vault set example_db_password --value "super_secret_password_123"
...
API_KEY=$(cockpit vault get example_api_key)
DB_PASSWORD=$(cockpit vault get example_db_password)
...
export EXAMPLE_API_KEY=$(cockpit vault get example_api_key)
export EXAMPLE_DB_PASSWORD=$(cockpit vault get example_db_password)
...
# 6. Limpar secrets de teste
echo "6. Limpando secrets de teste..."
cockpit vault remove example_api_key
echo "   ✓ example_api_key removido"

cockpit vault remove example_db_password
